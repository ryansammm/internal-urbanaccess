...
var optionKabupaten = "";
$("#provinsiIdentitas").on("change", function () {
    optionKabupaten = '<option value="">Pilih Kabupaten</option>';
    if ($(this).val() != "") {
        $.ajax({
            url: "/kabupaten/get/" + $(this).val(),
            ...
            $("#kabupatenIdentitas").html(optionKabupaten);
            $("#kabupatenIdentitas").prop("disabled", false);
        });
    }
});

var optionKecamatan = "";
$("#kabupatenIdentitas").on("change", function () {
    optionKecamatan = '<option value="">Pilih Kecamatan</option>';
    if ($(this).val() != "") {
        $.ajax({
            url: "/kecamatan/get/" + $(this).val(),
            ...
            $("#kecamatanIdentitas").html(optionKecamatan);
            $("#kecamatanIdentitas").prop("disabled", false);
        });
    }
});

var optionKelurahan = "";
$("#kecamatanIdentitas").on("change", function () {
    optionKelurahan = '<option value="">Pilih Kelurahan</option>';
    if ($(this).val() != "") {
        $.ajax({
            url: "/kelurahan/get/" + $(this).val(),
            ...
            $("#kelurahanIdentitas").html(optionKelurahan);
            $("#kelurahanIdentitas").prop("disabled", false);
        });
    }
});
