                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="idLayanandetail" id="kecepatan" class="form-control" disabled>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kodeformInternetregistrasi" value="<?= $kode_form ?>">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggalRegistrasi">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="namauserRegistrasi">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="telpkontak">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nikPic">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="first-name-vertical">Nama PIC Internal </label>
                                        <input type="text" class="form-control" name="namaPic">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="ppnbiayainstalasi" id="" class="form-select" required>
                                            <option value="">-- PPN Biaya Registrasi --</option>
