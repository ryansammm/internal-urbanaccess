        ...
        <section class="section">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Dokumentasi Survey Onsite</h4>
                        <div style="background-color: #589cd1;height: 2px;margin-bottom: 20px;"></div>
                        <form method="post" action="/input-hasil-survey-onsite/dokumentasi/<?= $id ?>/store" enctype="multipart/form-data" class="dropzone" id="dropzonewidget">

                        </form>
                    </div>
                    <div class="card-footer">
                        <div class="col-12 d-flex justify-content-end">
                            <a href="/input-hasil-survey-onsite" class="btn btn-primary me-1 mb-1">Submit</a>
                        </div>
                    </div>
                </div>
            </div>
