            ...
            <form class="form form-vertical" method="post" action="/user-management/<?= $detail['idUser'] ?>/update" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <h4 class="card-title">Form Ubah Data Akun User</h4>
                                ...
                                <div class="card-body  rounded">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="namaUser" value="<?= $detail['namaUser'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body  rounded">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" placeholder="Password" name="konfirmasiPassowrd" id="confirm_password" required>
