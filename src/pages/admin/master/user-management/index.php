            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <a type="button" class="btn btn-sm btn-primary mb-1" href="/user-management/create">Tambah Data <i class="fas fa-plus"></i></a>
                            ...
                            <tbody>
                                <?php foreach ($datas as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/user-management/<?= $value['idUser'] ?>/edit" class="btn btn-sm btn-outline-primary "><i class="fas fa-edit"></i></a>
                                            <a href="/user-management/<?= $value['idUser'] ?>" class="btn btn-sm btn-outline-warning "><i class="fas fa-eye"></i></a>
                                            <a href="#" class="btn btn-sm btn-outline-danger  btn-hapus" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $value['idUser'] ?>"><i class="fas fa-user-times"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<script>
    ...
    $(document).on('click', '.btn-hapus', function() {
        ...
        modal.find('.form-hapus').prop('action', '/user-management/' + id + '/delete');
    })
