...
<div id="main">
    ...
    <div class="card">
        <div class="card-content">
            <form class="form form-vertical" method="post" action="/reseller/store" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="col-1">
                        ...
                        <div class="col">
                            <h4 class="card-title">Form Tambah Reseller</h4>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nikSales" value="" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="first-name-vertical">Nama Reseller *</label>
                                    <input type="text" class="form-control" name="namaSales" value="" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="first-name-vertical">Singkatan *</label>
                                    <input type="text" class="form-control" name="singkatanSales" required>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kodeposSalesalamat">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="alamatSales" id="" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
