                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                <li> <a href="#" class="dropdown-item btn-sm btn-outline-success text-success btn-hapus" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $value['noRegistrasi'] ?>"><i class="fas fa-check"></i> Aktifkan</a></li>
                                                <li> <a href="#" class="dropdown-item btn-sm btn-outline-danger text-danger btn-hapus" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?= $value['noRegistrasi'] ?>"><i class="fas fa-power-off"></i> Matikan</a></li>
                                            </ul>
