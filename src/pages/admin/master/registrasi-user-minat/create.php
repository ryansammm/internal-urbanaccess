                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="idLayanandetail" id="kecepatan" class="form-control">
                                            <?php foreach ($layanan_detail as $key => $value) { ?>
                                                <option <?= $value['idLayananinternetdetail'] == $data_minat_layanan['idLayanandetail'] ? 'selected' : '' ?> value="<?= $value['idLayananinternetdetail'] ?>"><?= $value['kecepatan'] ?> Mbps</option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select name="jenisuserRegistrasi" id="" class="form-control" required>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="idUser" value="<?= $data_minat['namapemohon'] . "_" . $user_id ?>" required>
                                    </div>
                                </div>
