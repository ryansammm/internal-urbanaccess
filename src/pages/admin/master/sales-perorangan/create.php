...
<div id="main">
    ...
    <div class="card">
        <div class="card-content">
            <form class="form form-vertical" method="post" action="/sales-perorangan/store" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <h4 class="card-title">Form Tambah Sales Perorangan</h4>
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nikSales" value="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="first-name-vertical">Nama Sales *</label>
                                    <input type="text" class="form-control" name="namaSales" value="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="first-name-vertical">Tanggal Bergabung *</label>
                                    <input type="date" class="form-control" name="tanggalbergabungSales">
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 70%;">
                                                    <div class="input-group">
                                                        <input type="text" name="norekeningBanksales" id="" class="form-control">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telpkontak" value="">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="emailkontak">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="kodeposSalesalamatSaatIni">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical">Alamat *</label>
                                    <textarea name="alamatSalesSaatIni" id="" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="first-name-vertical">Kode Pos *</label>
                                    <input type="text" class="form-control" name="kodeposSalesalamatIdentitas">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical">Alamat *</label>
                                    <textarea name="alamatSalesIdentitas" id="" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
