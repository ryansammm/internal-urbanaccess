                    ...
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex">
                            <div class="user-name text-end me-3">
                                <h6 class="mb-0 text-black-600" style="color: black;">Admin</h6>
                                <p class="mb-0 text-sm text-black-600" style="color: black;">Administrator</p>
                            </div>
            ...
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub <?= strpos($GLOBALS['url'], '/minat')  !== false ? 'active' : ''; ?>">
                    ...
                    <ul class="submenu" style="display: none;">
                        ...
                        <!-- <li class="submenu-item">
                            <a href="/daftar-survey">Daftar Survey</a>
                        </li> -->
                        <li class="submenu-item">
