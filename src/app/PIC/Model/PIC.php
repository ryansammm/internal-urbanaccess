...
class PIC extends GlobalFunc
{
    ...
    public function create($datas)
    {
        ...
        $tempatlahirPic = isset($datas['tempatlahirPic']) ? $datas['tempatlahirPic'] : NULL;
        ...
        $sql = "INSERT INTO " . $this->table . " VALUES ('$nikPic','$namaPic', '$tempatlahirPic', '$tanggallahirPic', '$statusPic', '$jabatanPic', '$createdAt', '$updatedAt')";
        // dd($sql);
