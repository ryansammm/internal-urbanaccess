...
namespace App\UrbanLite\Controller;
...
class UrbanLiteController extends GlobalFunc
{
    public $model;
    ...
    public function create(Request $request)
    {
        ...
        return $this->render_template('admin/master/urban-lite/create', ['provinsi' => $data_provinsi, 'data_sales' => $data_sales, 'layanan' => $layanan, 'layanan_detail' => $layanan_detail, 'data_minat' => $data_minat, 'data_minat_layanan' => $data_minat_layanan, 'data_kontak_telp' => $data_kontak_telp, 'data_kontak_whatsapp' => $data_kontak_whatsapp, 'data_kontak_email' => $data_kontak_email, 'data_user_requset_survey' => $data_user_requset_survey, 'data_vendor' => $data_vendor, 'kode_form' => $kode_form]);
    }
