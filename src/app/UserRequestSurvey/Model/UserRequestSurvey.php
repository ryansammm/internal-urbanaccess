...
namespace App\UserRequestSurvey\Model;

use Core\GlobalFunc;

class UserRequestSurvey extends GlobalFunc
{
    ...
    {
        $sql = "SELECT userrequestsurvey.*, minat.namaPemohon, layananinternet.namaLayanan, layananinternetdetail.kecepatan, minat.alamat, vendor.namaVendor, userrequestsurvey.status FROM " . $this->table . " LEFT JOIN minat ON minat.kodeMinat = userrequestsurvey.kodeMinat LEFT JOIN vendor ON vendor.idVendor = userrequestsurvey.idVendor LEFT JOIN minatlayanan ON minatlayanan.idMinat = minat.kodeMinat LEFT JOIN layananinternet ON layananinternet.idLayananinternet = minatlayanan.idLayanan LEFT JOIN layananinternetdetail ON layananinternetdetail.idLayananinternet = layananinternet.idLayananinternet " . $where;
    ...
    public function updateStatus($id, $status)
    {
        ...
        $sql = "UPDATE " . $this->table . " SET status = '$status' WHERE idVendor = '$id'";
        // dd($sql);
